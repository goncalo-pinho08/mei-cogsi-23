...
public class JMXTomcatHeapMemoryMonitorHandler implements NotificationListener {
    ...
    public void handleNotification(Notification notification, Object handback) {
        ...
        String command = "echo -e \"tomcat;TomcatPassive;2;Heap Memory usage is high\" | /usr/local/nagios/bin/send_nsca -H "+hostaddress+" -d \";\" -c /usr/local/nagios/etc/send_nsca.cfg";
